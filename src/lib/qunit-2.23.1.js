...
if (true) {
  (function () {
    ...
    Test.prototype = {
      ...
      finish: function finish() {
        ...
        if (config.requireExpects && this.expected === null) {
          ...
          this.pushFailure(
            "Expected " + this.expected + " assertions, but " + actualCountForExpect + " were run",
            this.stack,
          );
          ...
          },
          {
            ...
            value: function onTestEnd(test) {
              ...
              if (test.status === "passed") {
                ...
                this.log(
                  "ok ".concat(this.testCount, " ").concat($.yellow("# SKIP ".concat(test.fullName.join(" > ")))),
                );
              } else if (test.status === "todo") {
                this.log(
                  "not ok ".concat(this.testCount, " ").concat($.cyan("# TODO ".concat(test.fullName.join(" > ")))),
                );
    ...
    extend(QUnit, {
      ...
      load: function load() {
        Logger.warn(
          "QUnit.load is deprecated and will be removed in QUnit 3.0." + " https://qunitjs.com/api/QUnit/load/",
        );
        QUnit.autostart();
      },
      /**
